...
public class AutoMenosTempoRed extends OpMode {

    private Follower follower;
    private Launcher launcher;

    public static Pose START_POS =
            new Pose(16.595573440643868, 119.1549295774648, Math.toRadians(144)).mirror();

    public static Pose SHOT_POS =
            new Pose(55.050301810865186, 91.84708249496983, Math.toRadians(140)).mirror();

    public static Pose ALIGN1_POS =
            new Pose(55.050301810865186, 84.0523138832998, Math.toRadians(180)).mirror();

    public static Pose COLLECT1_POS =
            new Pose(18.458752515090536, 84.0523138832998, Math.toRadians(180)).mirror();

    public static Pose ALIGN2_POS =
            new Pose(55.050301810865186, 57.26559356136822, Math.toRadians(180)).mirror();

    public static Pose COLLECT2_POS =
            new Pose(12.458752515090536, 57.26559356136822, Math.toRadians(180)).mirror();

    public static Pose ALIGN3_POS =
            new Pose(55.050301810865186, 35.82494969818917, Math.toRadians(180)).mirror();

    public static Pose AJUSTE =
            new Pose(18.050301810865186, 57.26559356136822, Math.toRadians(180)).mirror();

    public static Pose COLLECT3_POS =
            new Pose(12.458752515090536, 35.79074446680082, Math.toRadians(180)).mirror();

    // ===== POSIÇÃO FINAL =====
    public static Pose FINAL_POS =
            new Pose(26.366197183098592,
                    70.14486921529176,
    ...
    private PathChain goToFinal;   // NOVO
    ...
    private void buildPaths() {
        ...
        // SHOT -> FINAL
        goToFinal = follower.pathBuilder()
                .addPath(new BezierLine(SHOT_POS, FINAL_POS))
                .setLinearHeadingInterpolation(
                        SHOT_POS.getHeading(),
                        FINAL_POS.getHeading()
                )
                .build();
    }
