...
@Configurable
@Autonomous(name = "Vermelho Longe", group = "V1")
public class AutoFarRed extends OpMode {

    private Follower follower;
    private Launcher launcher;

    public static Pose START_POS = new Pose(57, 9, Math.toRadians(90)).mirror();
    public static Pose SHOT_POS  = new Pose(57, 13, Math.toRadians(111)).mirror();
    public static Pose HIGH_SHOT = new Pose(60, 82, Math.toRadians(130)).mirror();

    public static Pose LOW_ROW     = new Pose(24, 36, Math.toRadians(180)).mirror();
    public static Pose LOW_ROW_CP  = new Pose(72, 32);

    public static Pose MID_ROW     = new Pose(24, 64, Math.toRadians(180)).mirror();
    public static Pose MID_ROW_CP  = new Pose(72, 54).mirror();

    public static Pose HIGH_ROW    = new Pose(24, 88, Math.toRadians(180)).mirror();
    public static Pose HIGH_ROW_CP = new Pose(72, 86).mirror();

    public static Pose PARK = new Pose(33, 9, Math.toRadians(90)).mirror();
