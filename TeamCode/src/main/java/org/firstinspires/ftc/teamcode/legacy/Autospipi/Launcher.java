...
public class Launcher {
    ...
    // ticks por segundo
    public static double velocityNear = 1425;
    public static double velocityFar  = 1575;
    public static double autoFar  = 1475;
    public static double autoNear  = 1350;
    public static double autoFarThreshold  = 90;
    ...
    public boolean importantFunction() {
        ...
        boolean conditionMet =
                Math.abs(flywheelMaster.getVelocity()) > autoFar - 2 * autoFarThreshold ||
                        Math.abs(flywheelSlave.getVelocity()) > autoFar - 2 * autoFarThreshold;
