...
public class Autonomo_Collect1_Collect2_OpenGate_Collect3_Perto extends OpMode {
    ...
    private PathChain shotToC3;
    private PathChain c3ToShot;
    ...
    private void buildPaths() {
        ...
        shotToC3 = curve(
                PositionsdoPipi.SHOT,
                new Pose(117.6, 54.9, Math.toRadians(90)),
                PositionsdoPipi.COLLECT3
        );

        c3ToShot = curve(
                PositionsdoPipi.COLLECT3,
                new Pose(74.6, 24.6, Math.toRadians(90)),
                PositionsdoPipi.SHOT
        );
