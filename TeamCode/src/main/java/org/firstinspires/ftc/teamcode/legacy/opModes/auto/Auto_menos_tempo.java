...
@Configurable
@Autonomous(name = "Azul Perto", group = "V1")
public class Auto_menos_tempo extends OpMode {
    ...
    public static Pose ALIGN2_POS =
            new Pose(55.050301810865186, 57.26559356136822, Math.toRadians(180));

    public static Pose COLLECT2_POS =
            new Pose(12.458752515090536, 57.26559356136822, Math.toRadians(180));

    public static Pose ALIGN3_POS =
            new Pose(55.050301810865186, 35.82494969818917, Math.toRadians(180));

    public static Pose AJUSTE =
            new Pose(18.050301810865186, 57.26559356136822, Math.toRadians(180));

    public static Pose COLLECT3_POS =
            new Pose(12.458752515090536, 35.79074446680082, Math.toRadians(180));
